"""
Complete Face Recognition Pipeline - Masked Dataset with FaceNet
...
class FaceRecognitionPipeline:
    """Complete face recognition pipeline for masked dataset with FaceNet"""
    ...
    def __init__(self, 
        ...
        """
        Initialize pipeline with FaceNet and cosine similarity
    ...
    def process_image(self, image_path: Optional[str] = None,
        ...
        for face_data in segmentation_result['faces']:
            try:
                ...
                # Resize filtered face to target size (160x160 for FaceNet)
