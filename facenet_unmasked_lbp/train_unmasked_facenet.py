"""
Training script for unmasked dataset with FaceNet:
...
- Learning rate 0.01
- Fine-tuning enabled
- NO filtering (for unmasked dataset)
...
def main():
    print("=" * 70)
    print("Face Recognition Training - Unmasked Dataset with FaceNet")
    print("FaceNet | YOLO | 20 Epochs | Batch 16 | LR 0.01 | NO FILTERING")
    print("=" * 70)
    
    # Configuration
    train_dir = r'..\self-built-masked-face-recognition-dataset\AFDB_face_dataset'  # Relative path
    model_dir = 'models/unmasked_facenet_model'
    ...
    print("  - Filtering: NO (unmasked dataset)")
    print("  - Mask Detection: NO (unmasked dataset)")
    print("=" * 70)
    ...
    print("✓ FaceNet pipeline initialized (cosine similarity, no filtering)")
    ...
    print("  ✓ No filtering (faster processing)")
    print("  ✓ Fine-tuned for unmasked faces")
